return {
  ...
  config = function()
    ...
    local servers = {
      ...
      dockerls = {},
      -- sqlls = {
      --   -- Configuration to prevent crashes by setting a default connection/driver
      --   settings = {
      --       sqlls = {
      --           -- Use SQLite as a safe default driver for general SQL files
      --           connections = {
      --               {
      --                   driver = 'sqlite',
      --                   name = 'temp_sqlite',
      --                   database = ':memory:',
      --                   -- Disable auto-fetch, as this can crash the server on startup
      --                   -- if no actual database is connected.
      --                   automatic_fetch = false,
      --               }
      --           }
      --       },
      --   },
      --   -- Set the default filetype to ensure it runs correctly
